...
\title{A Sample Document Could Be Very Long Could Be Very Long%
       \protect\thanks{Footnote to the title.}}
...
In 1887, two students, Tseng-Fong Ling (\textzh{林振峰})
and Cheou-Tchen Tcheng (\textzh{郑守箴}) were sent by the Fuzhou Naval College
to l'\'{E}cole Normale Sup\'{e}rieur in Paris where they eventually
obtained their bachelor degrees in science in 1890.
...
Generating an ellipsis \ldots\    % `\ ' needed because TeX ignores spaces after
